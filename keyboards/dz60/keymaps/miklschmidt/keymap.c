...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------------------------------------+
   * | Ctrl |  Cmd  |  Alt  |              Space                | FN | RAlt  |  L  |  D  |  R  |
   * `-----------------------------------------------------------------------------------------'
   */
    ...
    [LAYER_DEFAULT] = LAYOUT_directional(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, LT(LAYER_UTIL, KC_SPC), LT(LAYER_UTIL, KC_SPC), LT(LAYER_UTIL, KC_SPC), MO(LAYER_EMOJI), KC_RALT, KC_LEFT, KC_DOWN, KC_RIGHT
    ),
